...
type SocialLoginRequest struct {
	...
	// OAuth authorization code (Google の redirect で web app が受け取り、サーバーへ渡す)。
...
const file_account_v1_account_proto_rawDesc = "" +
	...
	"\x14AUTH_PROVIDER_GOOGLE\x10\x012\xd2\x02\n" +
	"\x0eAccountService\x12P\n" +
	"\vSocialLogin\x12\x1e.account.v1.SocialLoginRequest\x1a\x1f.account.v1.SocialLoginResponse\"\x00\x12S\n" +
	"\fRefreshToken\x12\x1f.account.v1.RefreshTokenRequest\x1a .account.v1.RefreshTokenResponse\"\x00\x12A\n" +
	"\x06Logout\x12\x19.account.v1.LogoutRequest\x1a\x1a.account.v1.LogoutResponse\"\x00\x12V\n" +
	"\rDeleteAccount\x12 .account.v1.DeleteAccountRequest\x1a!.account.v1.DeleteAccountResponse\"\x00B\xaa\x01\n" +
	"\x0ecom.account.v1B\fAccountProtoP\x01ZAgithub.com/reverie-jp/piamap/internal/gen/pb/account/v1;accountv1\xa2\x02\x03AXX\xaa\x02\n" +
	"Account.V1\xca\x02\n" +
...
var file_account_v1_account_proto_goTypes = []any{
	...
	(*SocialLoginRequest)(nil),    // 2: account.v1.SocialLoginRequest
	(*SocialLoginResponse)(nil),   // 3: account.v1.SocialLoginResponse
	(*RefreshTokenRequest)(nil),   // 4: account.v1.RefreshTokenRequest
	(*RefreshTokenResponse)(nil),  // 5: account.v1.RefreshTokenResponse
	(*LogoutRequest)(nil),         // 6: account.v1.LogoutRequest
	(*LogoutResponse)(nil),        // 7: account.v1.LogoutResponse
...
var file_account_v1_account_proto_depIdxs = []int32{
	...
	2, // 3: account.v1.AccountService.SocialLogin:input_type -> account.v1.SocialLoginRequest
	4, // 4: account.v1.AccountService.RefreshToken:input_type -> account.v1.RefreshTokenRequest
	6, // 5: account.v1.AccountService.Logout:input_type -> account.v1.LogoutRequest
	8, // 6: account.v1.AccountService.DeleteAccount:input_type -> account.v1.DeleteAccountRequest
	3, // 7: account.v1.AccountService.SocialLogin:output_type -> account.v1.SocialLoginResponse
	5, // 8: account.v1.AccountService.RefreshToken:output_type -> account.v1.RefreshTokenResponse
	7, // 9: account.v1.AccountService.Logout:output_type -> account.v1.LogoutResponse
	9, // 10: account.v1.AccountService.DeleteAccount:output_type -> account.v1.DeleteAccountResponse
